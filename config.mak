...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --prefix=./android/armv7-a --enable-cross-compile --extra-libs=-lgcc --arch=arm --cc=/home/chsing/android/rk30_ics/prebuilt/linux-x86/toolchain/arm-eabi-4.4.3/bin/arm-eabi-gcc --cross-prefix=/home/chsing/android/rk30_ics/prebuilt/linux-x86/toolchain/arm-eabi-4.4.3/bin/arm-eabi- --nm=/home/chsing/android/rk30_ics/prebuilt/linux-x86/toolchain/arm-eabi-4.4.3/bin/arm-eabi-nm --sysroot=/home/chsing/android/android-ndk-r8b/platforms/android-9/arch-arm --extra-cflags='-I./android/armv7-a/include -O3 -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums  -fno-strict-aliasing -finline-limit=300 -mfloat-abi=softfp -mfpu=neon -marm -march=armv7-a -mtune=cortex-a8 ' --disable-shared --disable-debug --enable-static --extra-ldflags='-Wl,-rpath-link=/home/chsing/android/android-ndk-r8b/platforms/android-9/arch-arm/usr/lib -L/home/chsing/android/android-ndk-r8b/platforms/android-9/arch-arm/usr/lib -L./android/armv7-a/lib  -nostdlib -lc -lm -ldl -llog -lssl -lcrypto' --disable-everything --enable-gpl --enable-nonfree --enable-parsers --disable-encoders --enable-decoders --disable-muxers --enable-demuxers --disable-swscale --disable-swscale-alpha --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --enable-network --disable-indevs --disable-bsfs --disable-filters --disable-avfilter --enable-openssl --enable-protocols --enable-asm --enable-neon
...
ARCH=arm
CC=/home/chsing/android/rk30_ics/prebuilt/linux-x86/toolchain/arm-eabi-4.4.3/bin/arm-eabi-gcc
CXX=/home/chsing/android/rk30_ics/prebuilt/linux-x86/toolchain/arm-eabi-4.4.3/bin/arm-eabi-g++
AS=/home/chsing/android/rk30_ics/prebuilt/linux-x86/toolchain/arm-eabi-4.4.3/bin/arm-eabi-gcc
LD=/home/chsing/android/rk30_ics/prebuilt/linux-x86/toolchain/arm-eabi-4.4.3/bin/arm-eabi-gcc
DEPCC=/home/chsing/android/rk30_ics/prebuilt/linux-x86/toolchain/arm-eabi-4.4.3/bin/arm-eabi-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/home/chsing/android/rk30_ics/prebuilt/linux-x86/toolchain/arm-eabi-4.4.3/bin/arm-eabi-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=/home/chsing/android/rk30_ics/prebuilt/linux-x86/toolchain/arm-eabi-4.4.3/bin/arm-eabi-ar
ARFLAGS=rc
AR_O=$@
RANLIB=/home/chsing/android/rk30_ics/prebuilt/linux-x86/toolchain/arm-eabi-4.4.3/bin/arm-eabi-ranlib
CP=cp -p
LN_S=ln -sf
STRIP=/home/chsing/android/rk30_ics/prebuilt/linux-x86/toolchain/arm-eabi-4.4.3/bin/arm-eabi-strip
CPPFLAGS= --sysroot=/home/chsing/android/android-ndk-r8b/platforms/android-9/arch-arm -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -DPIC
CFLAGS=  -I./android/armv7-a/include -O3 -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums -fno-strict-aliasing -finline-limit=300 -mfloat-abi=softfp -mfpu=neon -marm -march=armv7-a -mtune=cortex-a8  -std=c99 -fomit-frame-pointer -fPIC -marm -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=vla
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -I./android/armv7-a/include -O3 -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums -fno-strict-aliasing -finline-limit=300 -mfloat-abi=softfp -mfpu=neon -marm -march=armv7-a -mtune=cortex-a8  -fPIC
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_O=-o $@
...
LD_PATH=-L
DLLTOOL=
LDFLAGS= -Wl,-rpath-link=/home/chsing/android/android-ndk-r8b/platforms/android-9/arch-arm/usr/lib -L/home/chsing/android/android-ndk-r8b/platforms/android-9/arch-arm/usr/lib -L./android/armv7-a/lib -nostdlib -lc -lm -ldl -llog -lssl -lcrypto  --sysroot=/home/chsing/android/android-ndk-r8b/platforms/android-9/arch-arm -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
...
EXTRALIBS=-lssl -lcrypto -lm -lz -lgcc 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
...
NOREDZONE_FLAGS=
libpostproc_VERSION=52.1.100
libpostproc_VERSION_MAJOR=52
libavcodec_VERSION=54.71.100
libavcodec_VERSION_MAJOR=54
libavdevice_VERSION=54.3.100
libavdevice_VERSION_MAJOR=54
libavfilter_VERSION=3.21.106
libavfilter_VERSION_MAJOR=3
libavformat_VERSION=54.35.100
libavformat_VERSION_MAJOR=54
libavresample_VERSION=1.0.0
libavresample_VERSION_MAJOR=1
libavutil_VERSION=52.4.100
libavutil_VERSION_MAJOR=52
libswresample_VERSION=0.16.100
libswresample_VERSION_MAJOR=0
libswscale_VERSION=2.1.102
